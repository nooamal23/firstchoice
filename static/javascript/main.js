...
; (function ($) {
    ...
    var overviewSlide = function () {
        $('.flat-overviews-slider').each(function () {
            ...
            $('.gallery_container').gallery_slider({
                imgNum: 3,
                imgArr: [
                    '/static/images/home1/overview-1.png',
                    '/static/images/home1/overview-2.png',
                    '/static/images/home1/overview-3.png',
                ]
            });
        });
    };
    ...
    $('#mainnav ul.menu > li a').each(function () {
        if ($(this).attr('href') === path) {
            $(this).parent().addClass('active').siblings().removeClass('active');
            // Handle submenu items
            if ($(this).parent().hasClass('item-has-child')) {
